...
function Navbar() {
  ...
  return (
    <div className='bg-green-200  sticky top-0 z-50'>
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "maliprathamesh3162@gmail.com"||"test123@gmail.com" ? <div className="flow-root">
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#" className="-m-2 flex items-center p-2">
                    ...
                    />
                    <span className="ml-3 block text-base font-medium text-gray-900" style={{ color: mode === 'dark' ? '' : '', }}>INDIA</span>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      className="inline-block w-10 h-10 rounded-full"
                      src="https://uronce.com/wp-content/uploads/2023/07/Fresh-Green-Grapes.jpg"
                      alt="Dan_Abromov" />
                  </a>
                </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <Link to={'/addproduct'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Add Product
                  ...
                  {user?.user?.email === 'maliprathamesh3162@gmail.com'||'test123@gmail.com' ? 
